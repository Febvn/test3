...
/* Mengimpor library React untuk komponen */
import React from 'react';
/* Mengimpor styled-components untuk styling komponen */
import styled from 'styled-components';

/* Tooltip - Komponen untuk menampilkan ikon media sosial dengan tooltip */
const Tooltip = () => {
  return (
    <StyledWrapper>
      {/* Daftar ikon media sosial dengan tooltip */}
      <ul className="example-1">
        {/* Ikon Spotify dengan tooltip "Facebook" */}
        ...
        {/* Ikon Pinterest dengan tooltip "Instagram" */}
        <li className="icon-content">
        ...
        {/* Ikon Dribbble dengan tooltip "Twitter" */}
        <li className="icon-content">
        ...
        {/* Ikon Telegram dengan tooltip "Mail" */}
        <li className="icon-content">
...
/* StyledWrapper - Komponen styled untuk mengatur tampilan tooltip dan ikon */
const StyledWrapper = styled.div`
  /* Menghapus style default dari list */
  ul {
    list-style: none;
  }

  /* Container utama untuk ikon media sosial */
  .example-1 {
    display: flex;
    ...
    /* Rotasi sedikit untuk efek visual */
    transform: rotate(-1deg);
  }

  /* Container untuk setiap ikon */
  ...
  /* Styling untuk SVG di dalam ikon */
