File: src/components/DateFilter.jsx
...
Penjelasan singkat:
- Komponen ini adalah UI sederhana untuk memilih tanggal awal dan akhir.
- Menggunakan prop `onFilter(from, to)` untuk meneruskan nilai tanggal ke parent.
- Menggunakan styled components untuk konsistensi tampilan.
